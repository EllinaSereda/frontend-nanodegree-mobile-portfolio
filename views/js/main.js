...
const pizza = document.querySelector('#pizzaSize');
const pizzaContainer = document.querySelectorAll('.randomPizzaContainer');
...
const pizzaElementGenerator = function (i) {
    ...
    let pizzaImageContainer; // contains the pizza image
    let pizzaImage; // the pizza image itself
    let pizzaDescriptionContainer; // contains the pizza title and list of ingredients
    let pizzaName; // the pizza name itself
    let ul; // the list of ingredients
    ...
    pizzaImage.src = 'images/pizza_compressed.png';
...
const resizePizzas = function (size) {
    ...
    function changeSliderLabel(size) {
        switch (size) {
            case '1':
                pizza.innerHTML = 'Small';
                return;
            case '2':
                pizza.innerHTML = 'Medium';
                return;
            case '3':
                pizza.innerHTML = 'Large';
                return;
            default:
    ...
    function changePizzaSizes(size) {
        const dx = determineDx(pizzaContainer[0], size);
        const newwidth = `${pizzaContainer[0].offsetWidth + dx}px`;
        for (let i = 0; i < pizzaContainer.length; i++) {
